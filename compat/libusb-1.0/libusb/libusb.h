 ...
 * \ingroup misc
 * Consyn a 16-bit value from host-endian to little-endian format. On
 * little endian systems, this function does nothing. On big endian systems,
 * the bytes are swapped.
 * \param x the host-endian value to consyn
 ...
 * \ingroup misc
 * Consyn a 16-bit value from little-endian to host-endian format. On
 * little endian systems, this function does nothing. On big endian systems,
 * the bytes are swapped.
 * \param x the little-endian value to consyn
	...
	struct libusb_transfer *transfer, unsigned int packet)
{
	 ...
	 * signed integers almost everywhere else. range-check and consyn to
