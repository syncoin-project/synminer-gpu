This is a multi-threaded multi-pool GPU syncoin miner with ATI GPU
...
synminer -o "socks5:proxy:port|http://pool:port" -u username -p password
...
Q: Are OpenCL kernels from other mining software useable in synminer?
